class UI {
    ...
    fillSearchedUserToUIFromStorage(){
        Storagex.getSearchedUserFromStorage();
    ...
    addSearchedUserToUI(username){
        // <li class="list-group-item">sumeyyesisman</li>
    ...
    addUserProfileToUI(user){
        ...
        <div id="profileDiv">
            <img id="profilImg" class="mb-2" src="${user.avatar_url}" width="200" height="200" alt="">
            <hr style="border: 1px solid lightslategray; width: 200px;">
            <span>${user.name}</span>
        </div>
    </div>
    <div class="col-sm-12 col-md-8 col-lg-8">
        <div id="badgeDiv" class="mt-1">
            <button type="button" class="btn btn-primary btn-sm">
                Takipçi <span class="badge text-bg-secondary">${user.followers}</span>
            </button>
